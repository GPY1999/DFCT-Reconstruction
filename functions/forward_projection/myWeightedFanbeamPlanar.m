function [sino] = myWeightedFanbeamPlanar(phant,sys_geo,varargin)
%MYWEIGHTEDFANBEAMPLANAR Weighted Radon Transform - fan beam for planar detector
%   INPUT:
...
for itheta = 1:length(theta_list)
    ...
    parfor ipixel = 1 : sys_geo.pixel_num
        ...
        % calculate intersection point of horizontal grids
